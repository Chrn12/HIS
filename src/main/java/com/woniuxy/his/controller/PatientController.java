...
public class PatientController {
	...
	public JsonResult selectPatientBills(Integer id) throws Exception{
		...
		Double adviceCost = advice.getTotalcost();		
	...
	public JsonResult updatePatientBills(Integer id,Double money,Double paymoney,LocalDateTime outTime) throws Exception{
	...
	public JsonResult selectPatientByIn(Integer pageNow,Integer showNum) throws Exception{				
		return new JsonResult("200","success",null,patientService.selectPatientsPageByIn(pageNow, showNum));			
	}
	
	@GetMapping("/byout")
	public JsonResult selectPatientByOut(Integer pageNow,Integer showNum) throws Exception{				
		return new JsonResult("200","success",null,patientService.selectPatientsPageByOut(pageNow, showNum));			
	}
