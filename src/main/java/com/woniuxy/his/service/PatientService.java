...
//	public List<Patient> selectPatientsByOut () throws Exception;
    ...
    public void updatePatientBills(Integer id,Double money,Double paymoney,LocalDateTime outTime)
            throws Exception;

    public IPage<Map<String,Object>> selectPatientsPageByIn (Integer pageNow,Integer showNum)
            throws Exception;
    public IPage<Map<String,Object>> selectPatientsPageByOut (Integer pageNow,Integer showNum)
            throws Exception;
